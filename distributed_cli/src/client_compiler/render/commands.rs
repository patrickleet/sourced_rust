...
const COMMAND_ARTIFACT_V2_TYPES: &str = r#"/**
...
pub(super) fn render_commands(manifest: &ClientManifest) -> Result<String, ClientCompileError> {
    ...
    if !manifest.commands.is_empty() {
        ...
        sections.push(COMMAND_ARTIFACT_V2_TYPES.into());
    }
...
fn render_command(
    ...
    Ok(format!(
        "export type {input_name} = {input_type};\n\n\
         ...
         export const Command_{}: CompilerReplicaCommandArtifactV2<{}, {}> = {};",
        identifier, input_name, output_name, artifact
    ))
}
