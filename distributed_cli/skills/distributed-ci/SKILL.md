...
- **Image repository**: defaults to `ghcr.io/<owner>/<repo>` (lowercased) when
  ...
  generated together. Cloud deploy templates accept only the tags generated by
  this delivery flow: `vMAJOR.MINOR.PATCH` for releases and
  `pr-NUMBER-40_HEX_SHA` for previews. The generated version workflow writes
  the release tag before promotion.
