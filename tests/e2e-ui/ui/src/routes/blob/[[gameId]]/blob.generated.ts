...
export type BlobGamesQuery = { blob_games: Array<{ game_id: string, owner_id: string, score: unknown, player_dead: boolean, current_level: unknown, current_level_completed: boolean, map_json: string, status: string, owner: { user_id: string, display_name: string, email: string, status: string } }> };
